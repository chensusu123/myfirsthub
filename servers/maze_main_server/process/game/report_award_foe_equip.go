...
//
//	logger.CtxInfo(ctx, "OnReportAwardFoeEquipRQ start", zap.Any("req", req))
//	defer func() {
//		err = s.Response(res)
//		logger.CtxInfo(ctx, "OnReportAwardFoeEquipRQ end", zap.Any("res", res))
//	}()
//
...
//	if equipNum <= 0 {
//		logger.CtxError(ctx, "OnReportAwardFoeEquipRQ equipNum fail", zap.Any("req", req))
...
//	if err != nil {
//		logger.CtxError(ctx, "OnReportAwardFoeEquipRQ GetUserInfoV2 fail", zap.Error(err))
...
//		logger.CtxError(ctx, "OnReportAwardFoeEquipRQ check barrier fail", zap.Error(err), zap.Any("req", req.GetBarrierId()), zap.Any("save", userInfo.Barrier))
...
//	//if err != nil {
//	//	logger.CtxError(ctx,"OnReportAwardFoeEquipRQ GetMazeShopInfo fail", zap.Error(err), zap.Any("barrier", req.GetBarrierId()), zap.Any("level", level))
//	//	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
//	//	return
//	//}
...
//	if err2 != nil {
//		logger.CtxError(ctx, "OnReportAwardFoeEquipRQ addEquipToBag fail", zap.Error(err2), zap.Any("optype", MazeEquipSvr.ENUM_EQUIP_BAG_OP_TYPE_MAZE_EQUIP_FOE),
...
//
//	if err = barrierscorerewardservice.GlobalScoreRewardService.SaveBarrierScoreRewardEquip(ctx, userId, req.GetBarrierId(), addEquipMap); err != nil {
//		logger.CtxError(ctx, "OnReportAwardFoeEquipRQ SaveBarrierScoreRewardEquip err", zap.Error(err), zap.Any("barrier", req.GetBarrierId()))
//		res.ErrInfo = errors.MODULE_ERROR.ToInfo()
//	}
//
//	return
