...
func OnGetFeoAwardRQ(logger fknet.TCPContext, shardingID uint64, rqMsg proto.Message, rsMsg proto.Message) (err error) {
	...
	// logger.CtxInfo(ctx,"OnGetFeoAwardRQ start", zap.Any("req", req))
	// defer func() {
	// 	logger.CtxInfo(ctx,"OnGetFeoAwardRQ end", zap.Any("res", res))
	// }()
	...
	// 	// logger.CtxError(ctx,"OnGetFeoAwardRQ kill monster empty")
	...
	// // areaCfg := GMazeBrushAreaV8Cfg.GetWithCtx(ctx,mazeAreaFoe.GetAreaId())
	// // if areaCfg == nil {
	// // 	logger.CtxError(ctx,"OnGetFeoAwardRQ get maze brush area cfg nil", zap.Any("areaId", req.GetAreaId()))
	// // 	res.ErrInfo = errors.CONFIG_NOT_FOUND.Wrap("找不到对应的区域id")
	// // 	return
	// // }
	// // if areaCfg.Barries != req.GetBarrierId() {
	// // 	logger.CtxError(ctx,"OnGetFeoAwardRQ barrier and area not match", zap.Any("barrierId", req.GetBarrierId()), zap.Any("areaId", req.GetAreaId()))
	...
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ GetCurrBarrier fail", zap.Error(err))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	// if barrierId != req.GetBarrierId() {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ curr barrier not match", zap.Any("barrierId", barrierId), zap.Any("req", req.GetBarrierId()))
	// 	res.ErrInfo = errors.COMMON_ERROR_TIPS.Wrap("关卡id不匹配")
	// 	return
	// }
	// barrierCfg := GMazeBarriesV8Cfg.GetWithCtx(ctx,req.GetBarrierId())
	// if barrierCfg == nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ get barrier cfg nil", zap.Any("barrierId", req.GetBarrierId()))
	...
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ GetUserInfo fail", zap.Error(err))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	...
	// 	return
	// }
	// shopCfg := GMazeShopV8Cfg.GetWithCtx(ctx,int32(level))
	// if shopCfg == nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ get maze shop cfg fail", zap.Any("level", level))
	// 	res.ErrInfo = errors.CONFIG_NOT_FOUND.ToInfo()
	// 	return
	// }
	...
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ GetMazeForce fail", zap.Error(err))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	...
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ GetUserBarrier fail", zap.Error(err))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	...
	// 		if addFoeCount < 0 {
	// 			logger.CtxError(ctx,"OnGetFeoAwardRQ req KillMonsterInfo foe count lt save data",
	// 				zap.Any("saveDefeatedFoe", uesrArea), zap.Any("area", area))
	// 			res.ErrInfo = errors.COMMON_ERROR_TIPS.Wrap("上报的杀怪数量小于存储的数值")
	// 			return
	// 		}

	// 		foeCfg := GMazeFoeV8Cfg.GetWithCtx(ctx,foe.GetConfigId())
	// 		if foeCfg == nil {
	// 			logger.CtxError(ctx,"OnGetFeoAwardRQ cant get foe cfg", zap.Any("foeId", foe.GetConfigId()))
	...
	// 		if err2 == nil {
	// 			logger.CtxError(ctx,"OnGetFeoAwardRQ GetCalRet fail", zap.Error(err2))
	...
	// 	if err2 != nil {
	// 		logger.CtxError(ctx,"OnGetFeoAwardRQ GetEquipMaxMap fail", zap.Error(err2), zap.Any("level", level))
	// 		res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 		return
	// 	}
	// 	logger.CtxInfo(ctx,"OnGetFeoAwardRQ GetEquipMaxMap dump", zap.Any("equipMax", equipMax), zap.Any("isFull", isFull))
	// 	if isFull {
	// 		needFoeEquip = false
	// 	} else {
	// 		shopInfo, err2 = mazeshopmodule.GetMazeShopInfo(logger, userId, int32(level), userInfo.HighArea)
	// 		if err2 != nil {
	// 			logger.CtxError(ctx,"OnGetFeoAwardRQ GetMazeShopInfo fail", zap.Error(err2), zap.Any("level", level))
	// 			res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 			return
	// 		}
	...
	// 		if err2 != nil {
	// 			logger.CtxError(ctx,"OnGetFeoAwardRQ GetMazeSeqEquipId fail", zap.Error(err2),
	...
	// 		if err2 != nil {
	// 			logger.CtxError(ctx,"OnGetFeoAwardRQ SetMazeShopInfo fail", zap.Error(err2), zap.Any("level", level), zap.Any("shopInfo", shopInfo))
	// 			res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 			return
	// 		}
	// 	}
	...
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ Marshal fail", zap.Error(err), zap.Any("mazeAreaFoe", mazeAreaFoe))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	...
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ SetUserBarrier fail", zap.Error(err), zap.Any("userBarrier", userBarrier))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	...
	// logger.CtxInfo(ctx,"OnGetFeoAwardRQ all award dump", zap.Any("foeList", mazeAreaFoe), zap.Any("level", level), zap.Any("force", force),
	...
	// 	} else {
	// 		logger.CtxError(ctx,"OnGetFeoAwardRQ AddMoney fail", zap.Error(err), zap.Any("currMoneyId", currMoneyId), zap.Any("addMoney", addMoney))
	// 	}
	// }
	...
	// 			Session: req.GetHeader().GetSession(),
	// 		})
	// 		newLevelCfg := GMazeLevelV8Cfg.GetWithCtx(ctx,int32(userInfo.Level))
	// 		if newLevelCfg != nil {
	// 			commonList = append(commonList, &CommonValueStruct{
	...
	// 			})
	// 		} else {
	// 			logger.CtxError(ctx,"OnGetFeoAwardRQ get new level cfg fail", zap.Any("level", userInfo.Level))
	// 		}
	...
	// 			})
	// 		} else {
	// 			logger.CtxError(ctx,"OnGetFeoAwardRQ MakeCommonValueExtra fail", zap.Error(err3), zap.Any("level", userInfo.Level), zap.Any("force", force))
	// 		}

	// 		res.AwardItems = append(res.AwardItems, &Common.Item{ItemId: proto.Int32(46500001), Count: proto.Int64(addExp)})

	// 	} else {
	// 		logger.CtxError(ctx,"OnGetFeoAwardRQ SetUserInfo fail", zap.Error(err), zap.Any("userInfo", userInfo))
	// 	}
	// } else {
	// 	logger.CtxError(ctx,"OnGetFeoAwardRQ AddExp fail", zap.Error(err), zap.Any("addExp", addExp))
	// }
	...
	// 	if errInfo != nil {
	// 		logger.CtxError(ctx,"OnGetFeoAwardRQ AddItemEx fail", zap.Any("errInfo", errInfo), zap.Any("addItems", addItems))
	// 	}
	...
	// 	if err2 != nil {
	// 		logger.CtxError(ctx,"OnGetFeoAwardRQ addEquipToBag fail", zap.Error(err2), zap.Any("optype", 19),
...
// func SendMoneyChgPack(ctx context.Context, userId uint64, currMoneyId int32, currCount int64, reason int32, session string) (err error) {
...
// 	logger.CtxInfo(ctx,"SendMoneyChgPack send client with", zap.Any("moneyPack", moneyPack))
...
func OnGetFeoAwardOldRQ(logger fknet.TCPContext, shardingID uint64, rqMsg proto.Message, rsMsg proto.Message) (err error) {
	...
	// logger.CtxInfo(ctx,"OnGetFeoAwardOldRQ start", zap.Any("req", req))
	// defer func() {
	// 	logger.CtxInfo(ctx,"OnGetFeoAwardOldRQ end", zap.Any("res", res))
	// }()
	...
	// // if areaCfg == nil {
	// // 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ get maze brush area cfg nil", zap.Any("areaId", req.GetAreaId()))
	// // 	res.ErrInfo = errors.CONFIG_NOT_FOUND.Wrap("找不到对应的区域id")
	// // 	return
	// // }
	// // if areaCfg.Barries != req.GetBarrierId() {
	// // 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ barrier and area not match", zap.Any("barrierId", req.GetBarrierId()), zap.Any("areaId", req.GetAreaId()))
	// // 	res.ErrInfo = errors.COMMON_ERROR_TIPS.Wrap("关卡与区域不匹配")
	// // 	return
	// // }
	...
	// barrierId, _, _, err := mazebarrier.GetMazeInfo(logger, userId)
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ GetCurrBarrier fail", zap.Error(err))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	// if barrierId != req.GetBarrierId() {
	// 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ curr barrier not match", zap.Any("barrierId", barrierId), zap.Any("req", req.GetBarrierId()))
	// 	res.ErrInfo = errors.COMMON_ERROR_TIPS.Wrap("关卡id不匹配")
	// 	return
	// }
	// barrierCfg := GMazeBarriesV8Cfg.GetWithCtx(ctx,req.GetBarrierId())
	// if barrierCfg == nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ get barrier cfg nil", zap.Any("barrierId", req.GetBarrierId()))
	// 	res.ErrInfo = errors.CONFIG_NOT_FOUND.ToInfo()
	// 	return
	// }
	...
	// userInfo, err := mazeuserinfo.GetUserInfo(logger, userId)
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ GetUserInfo fail", zap.Error(err))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	// level := userInfo.Level
	...
	// shopCfg := GMazeShopV8Cfg.GetWithCtx(ctx,int32(level))
	// if shopCfg == nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ get maze shop cfg fail", zap.Any("level", level))
	// 	res.ErrInfo = errors.CONFIG_NOT_FOUND.ToInfo()
	// 	return
	// }
	...
	// force, err := mazecalcattrredis.GetMazeForce(logger, userId)
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ GetMazeForce fail", zap.Error(err))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	...
	// userBarrier, err := mazeuserbarrier.GetUserBarrier(logger, userId, barrierId)
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ GetUserBarrier fail", zap.Error(err))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	...
	// 	foeCfg := GMazeFoeV8Cfg.GetWithCtx(ctx,foe.GetFoeId())
	// 	if foeCfg == nil {
	// 		logger.CtxError(ctx,"OnGetFeoAwardOldRQ cant get foe cfg", zap.Any("foeId", foe.GetFoeId()))
	// 		res.ErrInfo = errors.CONFIG_NOT_FOUND.Wrap("找不到怪物配置")
	// 		return
	// 	}
	...
	// 		foeCfg.Drop_exp_num[int32(level)], foeCfg.Drop_coin_num[int32(level)], foeCfg.Drop_equip_score_num[int32(level)])
	// 	if err2 != nil {
	// 		logger.CtxError(ctx,"OnGetFeoAwardOldRQ GetCalRet fail", zap.Error(err2))
	// 		res.ErrInfo = errors.CONFIG_NOT_FOUND.Wrap("计算奖励失败")
	// 		return
	// 	}
	...
	// 	equipMax, isFull, err2 := mazeshopmodule.GetEquipMaxMap(logger, userId, int32(level), userInfo.HighArea)
	// 	if err2 != nil {
	// 		logger.CtxError(ctx,"OnGetFeoAwardOldRQ GetEquipMaxMap fail", zap.Error(err2), zap.Any("level", level))
	// 		res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 		return
	// 	}
	// 	logger.CtxInfo(ctx,"OnGetFeoAwardOldRQ GetEquipMaxMap dump", zap.Any("equipMax", equipMax), zap.Any("isFull", isFull))
	// 	if isFull {
	// 		needFoeEquip = false
	// 	} else {
	// 		shopInfo, err2 = mazeshopmodule.GetMazeShopInfo(logger, userId, int32(level), userInfo.HighArea)
	// 		if err2 != nil {
	// 			logger.CtxError(ctx,"OnGetFeoAwardOldRQ GetMazeShopInfo fail", zap.Error(err2), zap.Any("level", level))
	// 			res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 			return
	// 		}
	...
	// 		addEquipMap, err2 = mazeshopmodule.GetMazeSeqEquipId(logger, userId, int32(level), userInfo.HighArea, shopInfo, 1, 0, equipMax)
	// 		if err2 != nil {
	// 			logger.CtxError(ctx,"OnGetFeoAwardOldRQ GetMazeSeqEquipId fail", zap.Error(err2),
	// 				zap.Any("shopInfo", shopInfo), zap.Any("equipMax", equipMax))
	// 			res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 			return
	// 		}
	...
	// 		err2 = dollmazeshopseqredis.SetMazeShopInfo(logger, userId, int32(level), shopInfo)
	// 		if err2 != nil {
	// 			logger.CtxError(ctx,"OnGetFeoAwardOldRQ SetMazeShopInfo fail", zap.Error(err2), zap.Any("level", level), zap.Any("shopInfo", shopInfo))
	// 			res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 			return
	// 		}
	// 	}
	...
	// if err != nil {
	// 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ SetUserBarrier fail", zap.Error(err), zap.Any("userBarrier", userBarrier))
	// 	res.ErrInfo = errors.MODULE_ERROR.ToInfo()
	// 	return
	// }
	...
	// logger.CtxInfo(ctx,"OnGetFeoAwardRQ all award dump", zap.Any("foeList", req.GetDefeatedFoeList()), zap.Any("level", level), zap.Any("force", force),
	// 	zap.Any("addMoney", addMoney), zap.Any("addEquipPoint", addEquipPoints), zap.Any("addExp", addExp),
	// 	zap.Any("addBlood", addBlood), zap.Any("isHaveEquip", needFoeEquip), zap.Any("addEquip", addEquipMap))
	...
	// 		res.AwardItems = append(res.AwardItems, &Common.Item{ItemId: proto.Int32(currMoneyId), Count: proto.Int64(addMoney)})
	// 	} else {
	// 		logger.CtxError(ctx,"OnGetFeoAwardOldRQ AddMoney fail", zap.Error(err), zap.Any("currMoneyId", currMoneyId), zap.Any("addMoney", addMoney))
	// 	}
	...
	// 			})
	// 		} else {
	// 			logger.CtxError(ctx,"OnGetFeoAwardOldRQ get new level cfg fail", zap.Any("level", userInfo.Level))
	// 		}
	...
	// 			})
	// 		} else {
	// 			logger.CtxError(ctx,"OnGetFeoAwardOldRQ MakeCommonValueExtra fail", zap.Error(err3), zap.Any("level", userInfo.Level), zap.Any("force", force))
	// 		}
	// 		res.AwardItems = append(res.AwardItems, &Common.Item{ItemId: proto.Int32(46500001), Count: proto.Int64(addExp)})
	// 	} else {
	// 		logger.CtxError(ctx,"OnGetFeoAwardOldRQ SetUserInfo fail", zap.Error(err), zap.Any("userInfo", userInfo))
	// 	}
	// } else {
	// 	logger.CtxError(ctx,"OnGetFeoAwardOldRQ AddExp fail", zap.Error(err), zap.Any("addExp", addExp))
	// }
	...
	// 	errInfo := gentradeno.AddItemEx(logger, userId, 689, tradeNo, 0, 1, req.GetHeader(), addItems...)
	// 	if errInfo != nil {
	// 		logger.CtxError(ctx,"OnGetFeoAwardOldRQ AddItemEx fail", zap.Any("errInfo", errInfo), zap.Any("addItems", addItems))
	// 	}
	...
	// 	rs, err2 := addequip.AddEquipToBag(logger, userId, 19, tradeNo, addEquipMap)
	// 	if err2 != nil {
	// 		logger.CtxError(ctx,"OnGetFeoAwardOldRQ addEquipToBag fail", zap.Error(err2), zap.Any("optype", 19),
	// 			zap.Any("tradeNo", tradeNo), zap.Any("addEquip", addEquipMap), zap.Any("rs", rs))
	// 	}
	// 	PushDollMazeShopInfoLog(logger, userId, int32(level), shopInfo, rs.EquipList, 19, tradeNo, 0)
	// }
