...
func TestSendMessages(t *testing.T) {
	...
	messageID, err := GlobalGroupService.SendMessage(context.Background(), logger, app.Maze, int32(1), uint64(50000001), int32(1), "hello01")
	if err != nil {
...
func TestQueryMessages(t *testing.T) {
	messages, err := GlobalGroupService.QueryMessages(context.Background(), logger, app.Maze, int32(1), uint64(50000001), int(10))
	if err != nil {
