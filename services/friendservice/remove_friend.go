...
func (s *service) delReceiveFriendRequest(logger fklog.FKLogI, userId, fromUserId uint64) error {
	receives, err := friendmodel.NewReceiveFriendRequestModel(logger, userId)
	if err != nil {
