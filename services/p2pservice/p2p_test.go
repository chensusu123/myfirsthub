...
func TestSendMessages(t *testing.T) {
	...
	messageID, err := GlobalP2PService.SendMessage(context.Background(), logger, app.Maze, user, uint64(50000002), int32(1), "hello01")
	if err != nil {
...
func TestQueryMessages(t *testing.T) {
	...
	messages, err := GlobalP2PService.QueryMessages(context.Background(), logger, app.Maze, user, uint64(50000002), 0, 10)
	if err != nil {
