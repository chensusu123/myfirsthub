...
func TestSendMessages(t *testing.T) {
	...
	messageID, err := GlobalP2PService.SendMessage(context.Background(), app.Maze, user, uint64(50000001), int32(1), "hello022")
	if err != nil {
...
func TestQueryMessages(t *testing.T) {
	...
	messages, err := GlobalP2PService.QueryMessages(context.Background(), app.Maze, user, uint64(50000002), 0, 10)
	if err != nil {
