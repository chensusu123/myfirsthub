...
type BarrierStageCounterService interface {
	...
	// 增加杀怪数量
	AddKillMonsterNum(ctx context.Context, userId uint64, barrierId, stageId, monsterId, addVal int32, monsterGuid int64, curHp int64, maxHp int64, monsterPos string) (killMonsterNum int32, guidList []int64, err error)
	// 增加杀怪伤害值
